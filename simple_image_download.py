...
class Downloader:
    ...
    def download(self, keywords=None, limit=1, verbose=False,  image_dictt={}, nam="",cache=True, download_cache=False, timer=None):
        image_dictt={}
        count=1
        ...
        for name, (path, url) in content.items():
            ...
            if verbose:
                ...
                image_dictt[image_name]=url.url
